function ajaxFest() {
   $.post("festival.php", function(data){
      $(".master").html(data);
   });
}
function ajaxReso() {
   $.post("resource.php", function(data){
      $(".master").html(data);
   });
}
function ajaxMast() {
   $.post("masterStudentList.php", function(data){
      $(".master").html(data);
   });
}
function ajaxTeac() {
   $.post("teacher.php", function(data){
      $(".master").html(data);
   });
}
function ajaxStud() {
   $.post("student.php", function(data){
      $(".master").html(data);
   });
}
function ajaxRepo() {
...
/***************************************************
* editStudent()
*fills the input fields of editBox with data from selected row rar
****************************************************/
function editStudent(){
   ...
   document.getElementById('eInstrument').value  = cells[2].innerHTML;
   document.getElementById('eFestivals').value = cells[3].innerHTML;
   document.getElementById('ePoints').value = cells[4].innerHTML;
   document.getElementById('eLastFestival').value = cells[5].innerHTML;
   document.getElementById('eGradYear').value = cells[6].innerHTML;

   $('#editBox > h2').html("Edit: " + cells[0].innerHTML + " " + cells[1].innerHTML);
   var e = document.getElementById("editBox");
   e.style.display='block';
}
