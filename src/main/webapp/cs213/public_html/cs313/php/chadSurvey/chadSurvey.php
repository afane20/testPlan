   ...
   if (($_COOKIE['voted'] == 'true') OR ($_SESSION['voted'] == true))
	{
      ...
      echo("<a href='chadSurvey.php?view=true'>View Results</a>");      
      echo("<script type='text/javascript'>\n");
      echo("setTimeout('");
      echo("window.location = \"chadSurvey.php?view=true\"', 5000);");
      echo("</script>");
		exit(1);
	}
	else
	...
	$contents .= "<?xml-stylesheet type='text/xsl' href='chadSurvey.xsl' ?>\n";
