                    ...
                    <%
                      /* // The date format that is stored as the value
                       ...
                       // if(event.getDate() == $('.swiper-slide-active .date-hidden').text())
                        ...
                        { */
                      %>  
                        <div class="col-xs-12 col-md-6 event"><div class="col-xs-4 col-md-2 event-img">
                        <img src="${event.getPicture()}" alt="event" class="img-responsive"></div><div class="col-xs-5 col-md-7 event-title"><h1 class="text-muted event-title"> 
